  ...
  <section className='max-w-7xl mx-auto'>
    <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w-[500px]'>
          Create Through a collection of imaginative and visually stunning images gerenated by OpenAI
        </p>
      </div>
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        ...
        <div className='relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64  flex justify-center items-center'>
          {form.photo ? (
            ...
            />
          ) : (<img src={preview}  className='w-9/12  h9/12 object-contain opacity-40'/>)}
          {generatingImg  &&  (
    ...
    <div className='mt-10'>
          <p className='mt-2 text-[#666e75] text-[14px]'>
            Once you have created the Image you want, you can share with the others in the community
          </p>
